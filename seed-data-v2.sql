-- ============================================================
-- TrafficWatch AI — Demo/Seed Data (CORRECTED — UUID FIX)
-- ============================================================
-- !! WARNING: THIS IS DEMO/SEED DATA ONLY !!
-- Run this AFTER ALL migration files have been applied.
-- This version uses gen_random_uuid() for all IDs and
-- subqueries for all foreign-key references.
-- ============================================================

-- ============================================================
-- SECTION 1: OFFICER PROFILES
-- Note: These profiles reference auth.users which must exist first.
-- If you haven't created these user accounts yet, the INSERT will
-- still work because profiles.id is independent of auth.users.
-- ============================================================
